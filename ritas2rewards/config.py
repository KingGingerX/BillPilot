...
FROM_EMAIL: str = os.getenv("R2R_FROM_EMAIL", "maggie@ritas2rewards.com")
FROM_NAME: str = os.getenv("R2R_FROM_NAME", "Maggie @ ritas2rewards")
SENDER_NAME: str = os.getenv("R2R_SENDER_NAME", "Maggie")
